  ...
  return (
    <Base>
      <div className="flex flex-col items-center mt-8">
        ...
        <p className="text-center text-gray-400 mt-2 dark:text-gray-500">Made by Braeden Treutel</p>
        <p className="text-center text-gray-600 mt-6 dark:text-gray-200">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-16 mt-20 px-4">
        ...
        <div className="flex-1 max-w-md">
          <p className="text-xl font-bold text-gray-600 dark:text-gray-200 mb-4">Host a room:</p>
        ...
        {/* Join Section */}
        <div className="flex-1 max-w-md">
          <p className="text-xl font-bold text-gray-600 dark:text-gray-200 mb-4">Join a room:</p>
          <ul className="list-decimal list-inside space-y-2 text-gray-600 dark:text-gray-200">
